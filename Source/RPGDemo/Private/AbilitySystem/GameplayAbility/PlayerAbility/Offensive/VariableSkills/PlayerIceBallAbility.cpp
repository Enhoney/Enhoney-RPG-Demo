...
#include "AbilitySystem/GameplayAbility/PlayerAbility/Offensive/VariableSkills/PlayerIceBallAbility.h"

void UPlayerIceBallAbility::GetAbilityDescOnLevel(UAbilitySystemComponent* InASC, int32 InAbilityLevel, FString& OutDescription) const
{
	...
	OutDescription = FString::Printf(TEXT(
		...
		<AbilityDesc>向目标发射一枚冰球，造成：</><Blue>%s</><AbilityDesc>元素伤害</>\t\
		<AbilityDesc>技能倍率：</><Blue>%.0f%%</>\
